...
import { MatIconModule, MatRippleModule, MatButtonModule, MatExpansionModule } from '@angular/material';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    UsersRoutingModule,
    MatIconModule, MatRippleModule, MatButtonModule, MatExpansionModule
  ]
})
